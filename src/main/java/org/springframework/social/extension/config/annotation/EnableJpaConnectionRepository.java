...
/**
 * Annotation to enable Jpa-based persistence of connections.
...
@Documented
@Inherited
@Import(JpaConnectionRepositoryRegistrar.class)
public @interface EnableJpaConnectionRepository {
	...
	/**
	 * The ID of a JpaTemplate for accessing the database.
	 * Defaults to "jpaTemplate". 
	 */
	String jpaTemplateRef() default "jpaTemplate";
