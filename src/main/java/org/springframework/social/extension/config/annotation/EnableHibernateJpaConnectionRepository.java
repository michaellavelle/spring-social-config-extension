...
/**
 * Annotation to enable Hibernate-Jpa-based persistence of connections.
 * Configures a singleton {@link JpaUsersConnectionRepository} and a request-scoped JpaConnectionRepository. 
...
@Documented
@Inherited
@Import(HibernateJpaConnectionRepositoryRegistrar.class)
public @interface EnableHibernateJpaConnectionRepository {
	...
	/**
	 * The ID of a subclass of AbstractUserConnectionJpaDao for accessing the database.
	 * Defaults to "userConnectionDao". 
	 */
	String userConnectionDaoRef() default "userConnectionDao";
